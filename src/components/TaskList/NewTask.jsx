  ...
  return (
    <div className="shrink-0 w-80 h-fit bg-slate-800/60 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 shadow-lg hover:shadow-xl hover:border-slate-600/50 transition duration-200">
      ...
      <div className="flex items-start justify-between mb-4">
        <span className="inline-block px-3 py-1 bg-blue-500/20 border border-blue-500/30 text-blue-400 text-xs font-semibold rounded-full">
          {data.category}
        </span>
      ...
      {/* Action */}
      <button className="w-full px-4 py-2.5 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 hover:border-blue-500/50 text-blue-400 hover:text-blue-300 font-semibold text-sm rounded-lg transition duration-200">
        Accept Task
      </button>
    </div>
  );
